...
import { FaUser, FaEnvelope, FaPhone, FaMapMarkerAlt, FaEdit, FaSignOutAlt, FaGlobe, FaBuilding, FaHome } from 'react-icons/fa';
            ...
            <div className="container mx-auto px-4 py-8">
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 mb-8">
                        ...
                        {/* Success and Error Messages - Now handled by toast notifications */}
                    </div>
