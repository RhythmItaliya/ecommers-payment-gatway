          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-12">
            ...
            <div className="lg:col-span-2 xl:col-span-1 space-y-6">
              ...
              <p className="text-gray-300 text-base leading-relaxed max-w-md">
                Discover exceptional style and quality clothing for men and women. 
            ...
            <div className="space-y-6">
              ...
              <div className="pt-4">
                ...
                <div className="flex space-x-4">
                  {[
                    { Icon: BsFacebook, href: "https://facebook.com", color: "hover:text-blue-400" },
                    { Icon: BsTwitter, href: "https://twitter.com", color: "hover:text-blue-300" },
                    { Icon: BsInstagram, href: "https://instagram.com", color: "hover:text-pink-400" },
                    { Icon: BsLinkedin, href: "https://linkedin.com", color: "hover:text-blue-500" }
            ...
            <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
              <div className="flex items-center space-x-2">
                ...
                <p className="text-gray-400 text-sm">
                  &copy; 2024 SnapShop. All rights reserved.
                </p>
              </div>
