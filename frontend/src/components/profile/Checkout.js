...
const Checkout = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Navigate to RazorpayPayment component
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <div className="space-y-3">
                <label className="flex items-center space-x-3 cursor-pointer">
                  ...
                  />
                  <span className="text-neutral">Razorpay (Credit/Debit Cards, UPI, Net Banking)</span>
                </label>
              </div>
            </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <div className="space-y-4 mb-6">
            {cart && cart.map((item) => (
              <CheckOutItem key={item.productId?._id || item.product?._id || item.id || Math.random()} item={item} />
            ))}
          </div>
