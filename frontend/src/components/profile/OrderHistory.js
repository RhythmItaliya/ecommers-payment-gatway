              ...
              <div className="mb-6">
                ...
                <div className="space-y-3">
                  {selectedOrder.items.map((item, index) => (
                    <div key={index} className="flex items-center space-x-3 p-3 bg-light rounded-lg">
                      <img
                        src={item.productId?.image || item.productId?.pictures?.[0] || '/placeholder-product.jpg'}
                        alt={item.productId?.title || 'Product'}
                      ...
                      <div className="flex-1">
                        <p className="font-medium text-primary">{item.productId?.title || 'Unknown Product'}</p>
                        <p className="text-sm text-neutral">
                          Qty: {item.quantity} × {formatINRPrice(item.price)}
                        </p>
